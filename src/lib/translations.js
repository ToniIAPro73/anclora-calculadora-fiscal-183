...
export const translations = {
  ...
  es: {
    ...
    dateSelector: {
      ...
      cancel: "Cancelar",
      reset: "Reiniciar modal",
      confirmEdit: "Guardar cambios",
      rangeReady: "Rango listo",
      inputHint: "Editable y sincronizado con el calendario",
      ...
      resetDialogTitle: "¿Reiniciar la selección actual?",
